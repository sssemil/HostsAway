...
import sssemil.com.hostsaway.service.UpdateService;
...
public class BaseActivity extends SherlockFragmentActivity {
    ...
    public static final String EXTRA_APPLYING_RESULT = "sssemil.com.hostsaway.APPLYING_RESULT";
    public static final String EXTRA_NUMBER_OF_SUCCESSFUL_DOWNLOADS = "sssemil.com.hostsaway.NUMBER_OF_SUCCESSFUL_DOWNLOADS";
    public static final String EXTRA_UPDATE_STATUS_TITLE = "sssemil.com.hostsaway.UPDATE_STATUS.TITLE";
    public static final String EXTRA_UPDATE_STATUS_TEXT = "sssemil.com.hostsaway.UPDATE_STATUS.TEXT";
    public static final String EXTRA_UPDATE_STATUS_ICON = "sssemil.com.hostsaway.UPDATE_STATUS.ICON";
    public static final String EXTRA_BUTTONS_DISABLED = "sssemil.com.hostsaway.BUTTONS.ENABLED";
    // Intent definitions for LocalBroadcastManager to update status from other threads
    static final String ACTION_UPDATE_STATUS = "sssemil.com.hostsaway.UPDATE_STATUS";
    static final String ACTION_BUTTONS = "sssemil.com.hostsaway.BUTTONS";
