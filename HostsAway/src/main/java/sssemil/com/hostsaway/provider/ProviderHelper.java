...
public class ProviderHelper {
    ...
    /**
     * Imports blacklist from THashSet<String> into database of HostsAway
     *
     * @param context
     * @param whitelist
     */
    ...
    /**
     * Imports whitelist from THashSet<String> into database of HostsAway
     *
     * @param context
     * @param whitelist
     */
    ...
    /**
     * Imports redirection list from THashMap<String, String> into database of HostsAway, where keys are
